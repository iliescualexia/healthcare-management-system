  ...
  useEffect(() => {
    const fetchPastAppointments = async () => {
      try {
        ...
        const response = await axios.get(`${UrlConstants.APPOINTMENTS_URL}/find-past-appointments-for-doctor/${username}`, {
          headers: {
...
export default PastAppointmentsDoctors;
